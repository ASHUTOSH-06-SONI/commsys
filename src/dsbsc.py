...
class dsbsc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "dsbsc")
        ...
        self.band_pass_filter_1_0 = filter.fir_filter_ccf(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_1_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fc, Ac, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fm, Am, 0, 0)
        ...
        self.connect((self.band_pass_filter_1_0, 0), (self.qtgui_freq_sink_x_0_0_0, 0))
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.band_pass_filter_1_0, 0))
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_1_0.set_taps(firdes.band_pass(1, self.samp_rate, 4000, 6000, 1, window.WIN_HAMMING, 6.76))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.analog_sig_source_x_1_0_0.set_amplitude(self.Ac)
